...
class Category(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, null=True)  # nullable to allow generic activities
...
class RewardRule(models.Model):
    reward_rule_id = models.PositiveBigIntegerField(primary_key=True)
