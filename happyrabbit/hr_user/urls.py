...
urlpatterns = [
    ...
    path('onboarding/', happyrabbit.hr_user.views.UserOnBoardingView.as_view(), name='onboarding'),
    path('profile/', happyrabbit.hr_user.views.UserProfileView.as_view(), name='profile'),
]